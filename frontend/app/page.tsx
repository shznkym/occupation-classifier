      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <header className="text-center mb-12 animate-float">
          ...
          <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 glass rounded-full text-sm">
            ...
            <span className="text-gray-300">Google Gemini API (text-embedding-004 + gemini-2.0-flash-exp)</span>
          </div>
        </header>
        ...
        <footer className="mt-12 text-center text-gray-500 text-sm">
          <p>Powered by Google Gemini API (text-embedding-004 + gemini-2.0-flash-exp)</p>
